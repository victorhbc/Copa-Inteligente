!(function(t, e) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define([], e)
			: 'object' == typeof exports ? (exports._vantaEffect = e()) : (t._vantaEffect = e());
			...
			(r.VantaBase = class {
				constructor(t = {}) {
					...
					if (
						...
						const t = this.el;
						if (((this.el = Object(s.e)(t)), !this.el)) return void h('Cannot find element', t);
					}
					let e, i;
					for (e = 0; e < this.el.children.length; e++)
						(i = this.el.children[e]),
					...
					try {
						...
						return (
							...
							void (
								...
								(this.el.style.background = Object(s.a)(this.options.backgroundColor)))
							)
						);
					}
				...
				applyCanvasStyles(t, e = {}) {
					Object(s.c)(t.style, { position: 'absolute', zIndex: 0, top: 0, left: 0, background: '' }),
				...
				windowMouseMoveWrapper(t) {
					...
					i >= 0 &&
						...
						i <= e.width &&
						s <= e.height &&
						((this.mouseX = i), (this.mouseY = s), this.options.mouseEase || this.triggerMouseMove(i, s));
				}
					...
					return (
						...
						this.options.mouseEase &&
							...
							Math.abs(this.mouseEaseX - this.mouseX) + Math.abs(this.mouseEaseY - this.mouseY) > 0.1 &&
								((this.mouseEaseX = this.mouseEaseX + 0.05 * (this.mouseX - this.mouseEaseX)),
								(this.mouseEaseY = this.mouseEaseY + 0.05 * (this.mouseY - this.mouseEaseY)),
		...
		16: function(t, e, i) {
			...
			class r extends s.b {
				...
				onInit() {
					...
					for (t = 1; t <= this.ww; t++)
						for (e = 1; e <= this.hh; e++) {
							...
							const h = this.gg[t][e],
								...
								l = this.gg[t - 1][e - 1];
							Object(o.f)(0, 1)
								? ((i = new n.Face3(l, a, c)), (r = new n.Face3(a, c, h)))
								: ((i = new n.Face3(l, a, h)), (r = new n.Face3(l, c, h))),
								s.faces.push(i, r);
						}
					...
					h.position.set(-100, 250, -100),
						this.scene.add(h),
						(this.camera = new n.PerspectiveCamera(35, this.width / this.height, 50, 1e4));
					(this.cameraPosition = new n.Vector3(240, 200, 390)),
						(this.cameraTarget = new n.Vector3(140, -30, 190)),
				...
				onUpdate() {
					...
					Math.abs(e.tx - e.position.x) > 0.01 && ((t = e.tx - e.position.x), (e.position.x += 0.02 * t)),
						...
						Math.abs(e.tz - e.position.z) > 0.01 && ((t = e.tz - e.position.z), (e.position.z += 0.02 * t)),
			...
			(r.prototype.defaultOptions = { color: 21896, shininess: 30, waveHeight: 15, waveSpeed: 1, zoom: 1 }),
				r.initClass(),
